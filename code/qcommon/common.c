...
//wopMaster{
cvar_t	*wop_master[MAX_WOPMASTER_SERVERS];
cvar_t	*wop_masterHB[MAX_WOPMASTER_SERVERS];
cvar_t	*wop_masterSL[MAX_WOPMASTER_SERVERS];
cvar_t	*wop_Serverlist;
cvar_t	*wop_masterSendHeartBeat;
//wopMaster}
...
//wopMaster{
	wop_master[0]	= Cvar_Get ("wop_master1", WOP_MASTER1_ADDR, 0 );
	wop_master[1]	= Cvar_Get ("wop_master2", WOP_MASTER2_ADDR, 0 );
	wop_master[2]	= Cvar_Get ("wop_master3", "", CVAR_ARCHIVE );
	wop_masterHB[0] = Cvar_Get ("wop_master1HB", WOP_MASTER1_HB, 0 );
	wop_masterHB[1] = Cvar_Get ("wop_master2HB", WOP_MASTER2_HB, 0 );
	wop_masterHB[2] = Cvar_Get ("wop_master3HB", "/cgi-bin/wopMaster.cgi", CVAR_ARCHIVE );
	wop_masterSL[0] = Cvar_Get ("wop_master1SL", WOP_MASTER1_LIST, 0 );
	wop_masterSL[1] = Cvar_Get ("wop_master2SL", WOP_MASTER2_LIST, 0 );
	wop_masterSL[2] = Cvar_Get ("wop_master3SL", "/cgi-bin/wopServerlist.cgi", CVAR_ARCHIVE );

	wop_Serverlist = Cvar_Get ("wop_Serverlist", "2", 0 );
	wop_masterSendHeartBeat = Cvar_Get("wop_masterSendHeartBeat", "0", 0);
//wopMaster}
...
//	cvar_t	*fs;// ... nonCDKEY
	...
	Com_WriteConfigToFile( "wop_config.cfg" );
