...
"gametype" entity will spawn in selected gametypes ("ffa", "tournament", "single", "spray", "lps", "team", "ctl",
"sptp", "balloon") only "notfree"  when set to 1, entity will not spawn in "Free for all" and "Tournament" modes
...
void SP_func_static(gentity_t *ent) {
	...
	if (i == 1)
		level.rspraywall = ent;
	else if (i == 2)
		level.bspraywall = ent;
	else if (i == 3)
		level.nspraywall = ent;
}
