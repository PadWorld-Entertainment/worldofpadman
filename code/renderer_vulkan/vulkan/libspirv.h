...
#define LAST_VARIABLE(ENUM) ENUM, SPV_OPERAND_TYPE_LAST_VARIABLE_TYPE = ENUM, SPV_OPERAND_TYPE_LAST_OPTIONAL_TYPE = ENUM
...
SPIRV_TOOLS_EXPORT void spvValidatorOptionsSetUniversalLimit(spv_validator_options options,
															 spv_validator_limit limit_type, uint32_t limit);
...
SPIRV_TOOLS_EXPORT void spvValidatorOptionsSetRelaxStoreStruct(spv_validator_options options, bool val);
...
SPIRV_TOOLS_EXPORT void spvValidatorOptionsSetRelaxLogicalPointer(spv_validator_options options, bool val);
...
SPIRV_TOOLS_EXPORT void spvValidatorOptionsSetRelaxBlockLayout(spv_validator_options options, bool val);
...
// and may outlive it.
SPIRV_TOOLS_EXPORT spv_result_t spvTextToBinary(const spv_const_context context, const char *text, const size_t length,
...
// spv_text_to_binary_options_t.
SPIRV_TOOLS_EXPORT spv_result_t spvTextToBinaryWithOptions(const spv_const_context context, const char *text,
														   const size_t length, const uint32_t options,
														   spv_binary *binary, spv_diagnostic *diagnostic);
...
SPIRV_TOOLS_EXPORT spv_result_t spvBinaryToText(const spv_const_context context, const uint32_t *binary,
												const size_t word_count, const uint32_t options, spv_text *text,
...
SPIRV_TOOLS_EXPORT spv_result_t spvValidate(const spv_const_context context, const spv_const_binary binary,
											spv_diagnostic *diagnostic);
...
SPIRV_TOOLS_EXPORT spv_result_t spvValidateBinary(const spv_const_context context, const uint32_t *words,
...
SPIRV_TOOLS_EXPORT spv_diagnostic spvDiagnosticCreate(const spv_position position, const char *message);
...
typedef spv_result_t (*spv_parsed_header_fn_t)(void *user_data, spv_endianness_t endian, uint32_t magic,
...
// continue.
typedef spv_result_t (*spv_parsed_instruction_fn_t)(void *user_data,
...
SPIRV_TOOLS_EXPORT spv_result_t spvBinaryParse(const spv_const_context context, void *user_data, const uint32_t *words,
