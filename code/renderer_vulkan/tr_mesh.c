...
int R_ComputeLOD(trRefEntity_t *ent) {
	...
	if (dist > 0) {
		...
		float p1 = -radius * tr.viewParms.projectionMatrix[5] - dist * tr.viewParms.projectionMatrix[9] +
				   tr.viewParms.projectionMatrix[13];
		float p3 = radius * tr.viewParms.projectionMatrix[7] - dist * tr.viewParms.projectionMatrix[11] +
