...
static menucommon_s *g_hud_options[] = {
	&s_preferences.crosshair.generic,
	&s_preferences.tracecrosshair.generic,
	&s_preferences.indicatehealth.generic,
	&s_preferences.identifytarget.generic,
	&s_preferences.ffahudtheme.generic,
	&s_preferences.draw3dicons.generic,
	&s_preferences.teamoverlay.generic,
	&s_preferences.lagometer.generic,
	&s_preferences.voipmeter.generic,
	&s_preferences.timer.generic,
	&s_preferences.timeleft.generic,
	&s_preferences.realtime.generic,
	&s_preferences.fps.generic,
	&s_preferences.ups.generic,
	NULL
};

static menucommon_s *g_game_options[] = {
	&s_preferences.autoswitch.generic,
	&s_preferences.simpleitems.generic,
	&s_preferences.wallmarks.generic,
	&s_preferences.dynamiclights.generic,
	&s_preferences.flares.generic,
	&s_preferences.highqualitysky.generic,
	&s_preferences.lensFlare.generic,
	&s_preferences.ingamevideo.generic,
	&s_preferences.synceveryframe.generic,
	&s_preferences.forcemodel.generic,
	&s_preferences.glowmodel.generic,
	&s_preferences.hitsound.generic,
	NULL
};

static menucommon_s *g_chat_options[] = {
	&s_preferences.connotify.generic,
	&s_preferences.chatheight.generic,
	&s_preferences.chaticon.generic,
	&s_preferences.chatbeep.generic,
	&s_preferences.teamchatbeep.generic,
	&s_preferences.gesture.generic,
	&s_preferences.botchat.generic,
	&s_preferences.teamchatsonly.generic,
	&s_preferences.conscale.generic,
	&s_preferences.conautochat.generic,
	&s_preferences.conautoclear.generic,
	NULL
};

static menucommon_s *g_help_options[] = {
	&s_preferences.drawtooltip.generic,
	&s_preferences.drawfriend.generic,
	&s_preferences.whIcons.generic,
	&s_preferences.whTeamMates.generic,
	&s_preferences.whFrozenMates.generic,
	&s_preferences.whLPSfoe.generic,
	&s_preferences.whHStations.generic,
	&s_preferences.whSycTele.generic,
	&s_preferences.whBalloons.generic,
	&s_preferences.whKillerduck.generic,
	NULL
};
