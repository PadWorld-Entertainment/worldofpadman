...
static void CheckBSPBrush(bspbrush_t *brush) {
	int i, j;
...
static void BSPBrushWindings(bspbrush_t *brush) {
	int i, j;
	winding_t *w;
	plane_t *plane;
...
//===========================================================================
static bspbrush_t *TryMergeBrushes(bspbrush_t *brush1, bspbrush_t *brush2) {
	int i, j, k, n, shared;
...
static bspbrush_t *MergeBrushes(bspbrush_t *brushlist) {
...
// Changes Globals:		-
//===========================================================================
static bspbrush_t *IntersectBrush(bspbrush_t *a, bspbrush_t *b) {
	int i;
	bspbrush_t *front, *back;
	bspbrush_t *in;
...
// Changes Globals:		-
//===========================================================================
static int IntersectionContents(int c1, int c2) {
	int out;
