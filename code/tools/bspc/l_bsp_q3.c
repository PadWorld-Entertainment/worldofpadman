...
=============
*/
static void Q3_SwapBlock(int *block, int sizeOfBlock) {
	int i;
...
=============
*/
static void Q3_SwapBSPFile(void) {
	int i;
...
=============
*/
static int Q3_CopyLump(q3_dheader_t *header, int lump, void **dest, int size) {
	int length, ofs;
...
=============
*/
static void CountTriangles(void) {
...
=============
*/
static void Q3_AddLump(FILE *bspfile, q3_dheader_t *header, int lumpnum, void *data, int len) {
	q3_lump_t *lump;
...
=============
*/
static void Q3_WriteBSPFile(char *filename) {
...
================
*/
static void Q3_UnparseEntities(void) {
	char *buf, *end;
	epair_t *ep;
	char line[2048];
	int i;
