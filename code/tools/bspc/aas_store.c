...
int groundfacesonly = qfalse; // true;
//
...
static unsigned AAS_HashVec(vec3_t vec) {
	int x, y;
...
// Changes Globals:		-
//===========================================================================
static qboolean AAS_GetVertex(vec3_t v, int *vnum) {
	int i;
...
static unsigned AAS_HashEdge(int v1, int v2) {
	int vnum1, vnum2;
	//
	if (v1 < v2) {
		vnum1 = v1;
...
static void AAS_AddEdgeToHash(int edgenum) {
	int hash;
	aas_edge_t *edge;
...
static qboolean AAS_FindHashedEdge(int v1num, int v2num, int *edgenum) {
	int e, hash;
	aas_edge_t *edge;
...
// Changes Globals:		-
//===========================================================================
static qboolean AAS_GetEdge(vec3_t v1, vec3_t v2, int *edgenum) {
	int v1num, v2num;
	qboolean found;
...
static int AAS_PlaneTypeForNormal(vec3_t normal) {
	vec_t ax, ay, az;
...
static void AAS_AddPlaneToHash(int planenum) {
	int hash;
	aas_plane_t *plane;
...
static int AAS_PlaneEqual(vec3_t normal, float dist, int planenum) {
	float diff;
...
static qboolean AAS_FindHashedPlane(vec3_t normal, float dist, int *planenum) {
	int i, p;
	int hash, h;
...
static qboolean AAS_GetPlane(vec3_t normal, vec_t dist, int *planenum) {
...
static qboolean AAS_GetFace(winding_t *w, plane_t *p, int side, int *facenum) {
	int edgenum, i, j;
	aas_face_t *face;
...
static void AAS_StoreAreaSettings(tmp_areasettings_t *tmpareasettings) {
...
static int AAS_StoreArea(tmp_area_t *tmparea) {
	int side, edgenum, i;
	plane_t *plane;
	tmp_face_t *tmpface;
	aas_area_t *aasarea;
...
static int AAS_StoreTree_r(tmp_node_t *tmpnode) {
	int aasnodenum;
	plane_t *plane;
	aas_node_t *aasnode;
...
static void AAS_StoreBoundingBoxes(void) {
