...
static void AAS_InitTmpAAS(void) {
	// tmp faces
...
static void AAS_FreeTmpAAS(void) {
	tmp_face_t *f, *nextf;
	tmp_area_t *a, *nexta;
...
static void AAS_CheckFaceWindingPlane(tmp_face_t *face) {
...
static void AAS_CheckAreaWindingPlanes(void) {
	int side;
	tmp_area_t *tmparea;
	tmp_face_t *face;
...
static void AAS_RemoveAreaFaceColinearPoints(void) {
	int side;
	tmp_face_t *face;
	tmp_area_t *tmparea;
...
static void AAS_RemoveTinyFaces(void) {
	int side, num;
...
static void AAS_CreateAreaSettings(void) {
...
// Changes Globals:		-
//===========================================================================
static tmp_node_t *AAS_CreateArea(node_t *node) {
	int pside;
	int areafaceflags;
	portal_t *p;
	tmp_face_t *tmpface;
...
static tmp_node_t *AAS_CreateAreas_r(node_t *node) {
	tmp_node_t *tmpnode;
...
static void AAS_CreateAreas(node_t *node) {
...
static void AAS_PrintNumGroundFaces(void) {
	tmp_face_t *tmpface;
...
static void AAS_CheckSharedFaces(void) {
...
static void AAS_FlipFace(tmp_face_t *face) {
