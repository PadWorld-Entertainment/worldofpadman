...
static winding_t *AAS_SplitWinding(tmp_area_t *tmparea, int planenum) {
	tmp_face_t *face;
	plane_t *plane;
	int side;
...
static int AAS_TestSplitPlane(tmp_area_t *tmparea, vec3_t normal, float dist, int *facesplits, int *groundsplits,
							  int *epsilonfaces) {
...
static void AAS_SplitArea(tmp_area_t *tmparea, int planenum, tmp_area_t **frontarea, tmp_area_t **backarea) {
	int side;
...
static int AAS_FindBestAreaSplitPlane(tmp_area_t *tmparea, vec3_t normal, float *dist) {
	int side1, side2;
...
static tmp_node_t *AAS_SubdivideArea_r(tmp_node_t *tmpnode) {
	int planenum;
...
static tmp_node_t *AAS_GravitationalSubdivision_r(tmp_node_t *tmpnode) {
...
static tmp_node_t *AAS_RefreshLadderSubdividedTree_r(tmp_node_t *tmpnode, tmp_area_t *tmparea, tmp_node_t *tmpnode1,
...
//===========================================================================
static tmp_node_t *AAS_LadderSubdivideArea_r(tmp_node_t *tmpnode) {
...
static tmp_node_t *AAS_LadderSubdivision_r(tmp_node_t *tmpnode) {
	// if this is a solid leaf
	if (!tmpnode)
		return 0;
	// negative so it's an area
