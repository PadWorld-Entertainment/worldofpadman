...
{
	qer_editorimage textures/pad_marble/marble17
	{
		map $lightmap
		rgbGen identity
	}
	{
		map textures/pad_marble/marble17
		blendFunc GL_DST_COLOR GL_ZERO
		rgbgen identity
	}
	{
...
{
	qer_editorimage textures/pad_marble/marble10
	{
		map $lightmap
		rgbGen identity
	}
	{
		map textures/pad_marble/marble10
		blendFunc GL_DST_COLOR GL_ZERO
		rgbgen identity
	}
	{
...
{
qer_editorimage textures/particles/smoke
...
{
clampmap textures/particles/smoke
...
{
	qer_editorimage textures/pad_liquidfx/invis_effect
	qer_trans .5
	surfaceparm trans
	surfaceparm nonsolid
	surfaceparm water
