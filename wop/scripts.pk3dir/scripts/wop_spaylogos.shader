...
spraylogos/06_spider
{
	nopicmip
	{
		map spraylogos/06_spider
		blendFunc blend
		rgbGen vertex
		alphaGen vertex
	}
...
spraylogos/14_biohazard
{
	nopicmip
	{
		map spraylogos/14_biohazard
		blendFunc blend
		rgbGen vertex
		alphaGen vertex
	}
