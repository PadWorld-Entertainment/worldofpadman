...
CONTEXT_NAMES
{
	...
	[("Bones", 1),		("Skeleton", 0.5), ("Bonesy", 0.9), ("skullboy", 0.2)]
	[("Crash", 1),		("Doom Girl", 0.3), ("Doom Lady", 0.5), ("Doomette", 0.3)]
	...
	[("Sorlag", 1),		("Lizard Breath", 0.4), ("Sorg Scum", 0.4), ("Foul-mouth", 0.2), ("S-s-s-snake", 0.5)]
	[("Major", 1),		("Cyclops", 0.2), ("Boss Lady", 0.6), ("Ms. Major, Sir", 0.5), ("Major Witch", 0.1), ("Iron-thighs", 0.15)]
	[("Uriel", 1),		("Old Gargoyle", 0.3), ("Gargoyle-breath", 0.2), ("Lizard-face", 0.15)]
	...
	[("Hunter", 1),		("Ice Queen", 0.7), ("Princess", 0.3), ("Witch", 0.1), ("Feather-head", 0.6), ("~Sistah Chicken Hat", 0.01)]
	...
	[("Gorre", 1),		("Jerk", 0.6), ("Al", 0.5), ("Pansy", 0.3), ("Wuss", 0.1)]
	...
	[("Wrack", 1),		("Wrack 'n Ruin", 0.2), ("hard-guy", 0.6)]
