World of Padman WoP 1.6.2 full zip
by PadWorld Entertainment

Includes:
1. WoP 1.6.2 patch (28/11/2021)
2. WoP 1.6.1 patch (01/11/2021)
3. WoP 1.6 patch (17/12/2011)
4. WoP 1.5.1 hotfix (23/01/2011)
5. WoP 1.5 full release (27/12/2010)
6. Binaries (64 bit only) for Windows, Linux, and MacOS
7. Server configuration files for all game types
8. WoP editing files (WoP mapping files.zip & WoP radiant files.zip)

The WoP 1.6.2 full release does not require a prior WoP version.

Instructions:
Please extract the contents of the zip file with all relative paths
to a destination of your choice. For more information about changes
please have a look at XTRAS/changelog.txt.

Your WoP Team

Please visit https://worldofpadman.net
